...
@NamedQueries({
    ...
    , @NamedQuery(name = "Category.findByRowState", query = "SELECT c FROM Category c WHERE c.rowState = :rowState")})
public class Category implements Serializable {
    ...
    public Category(Integer id, String name, String rowState) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "eveniment.Entities.Category[ id=" + id + " ]";
    }
